var ew_EnableAzone = {
    ...
    loadbalancer : null,
    launch : function() {
        this.retVal.LoadBalancerName = document.getElementById("ew.enableazone.Name").value.trim();
	...
	document.getElementById("ew.enableazone.Name").value = loadbalancer.LoadBalancerName;
