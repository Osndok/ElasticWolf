var ew_LoadbalancerTreeView = {
    ...
    viewDetails : function(){
        ...
        if (loadbalancer == null) return;
        window.openDialog(
            "chrome://ew/content/dialogs/details_loadbalancer.xul",
            null,
    ...
    create: function() {
        var retVal = {ok:null};
        window.openDialog(
            "chrome://ew/content/dialogs/create_loadbalancer.xul",
            null,
            "chrome,centerscreen,modal,resizable",
            ew_session,
            retVal,
     ...
     ConfigureHealthCheck: function() {
        ...
        var retVal = {ok:null};
        window.openDialog(
            "chrome://ew/content/dialogs/configure_healthcheck.xul",
            null,
            "chrome,centerscreen,modal,resizable",
            loadbalancer,
            ew_session,
    ...
    registerinstances : function(){
        ...
        var retVal = {ok:null};
         window.openDialog(
            "chrome://ew/content/dialogs/register_lbinstances.xul",
            null,
            "chrome,centerscreen,modal,resizable",
            ew_session,
            retVal,
    ...
    deregisterinstances : function(){
        ...
        var retVal = {ok:null};
         window.openDialog(
            "chrome://ew/content/dialogs/deregister_lbinstances.xul",
            null,
            "chrome,centerscreen,modal,resizable",
            ew_session,
            retVal,
    ...
    enableazone : function(){
        ...
        var retVal = {ok:null};
        window.openDialog(
            "chrome://ew/content/dialogs/enable_lbazone.xul",
            null,
            "chrome,centerscreen,modal,resizable",
            ew_session,
            retVal,
    ...
    disableazone : function(){
        ...
        var retVal = {ok:null};
        window.openDialog(
            "chrome://ew/content/dialogs/disable_lbazone.xul",
            null,
            "chrome,centerscreen,modal,resizable",
            ew_session,
            retVal,
    ...
    disablestickness :function(){
        var loadbalancer = this.getSelectedLoadbalancer();
        if (loadbalancer == null) return;
        var confirmed = confirm(getProperty("ew.msg.loadbalancerview.confirm.delete")+loadbalancer.LoadBalancerName+"?");
        if (!confirmed)
            return;
        var me = this;
        var wrap = function() {
    ...
    applicationsticknesss :function(){
        ...
        var CookieName = prompt(getProperty("ew.msg.loadbalancerview.confirm.CookieName"));
        if (CookieName == null)
            return;
    ...
    loadbalancerstickness :function(){
        ...
        var CookieExpirationPeriod = prompt(getProperty("ew.msg.loadbalancerview.confirm.CookieExpirationPeriod"));
